          ...
          <div className="flex flex-1 flex-col justify-between p-3 bg-white dark:bg-slate-900 shrink-0 gap-2">
            ...
            <div className="pt-0.5">
              <button
                ...
                className={`w-full flex items-center justify-center gap-1 rounded-full bg-[#FF6584] hover:bg-[#EE4D6D] text-white py-1.5 px-3 text-[10px] sm:text-xs font-extrabold transition-all duration-200 active:scale-[0.98] ${isOutOfStock || isAdminOrVendor ? "opacity-50 cursor-not-allowed" : "cursor-pointer"} shadow-xs`}
              >
